...
function langonaOwlCarousel() {
  ...
  let srcLoad = setInterval(() => {
    $(".clients-img")
      .find("#clientActiveImg")
      .attr(
        "src",
        clientsSlider.find(".active .clients-item").attr("data-big-image-path")
      );
  }, 100);
  ...
  contactForm.on("submit", function (event) {
    ...
    if (
      ...
      $(this)
        .find(":submit")
        .append(
          '<span id="btn-loader" class="fas fa-spinner fa-pulse ml-3"></span>'
        );
